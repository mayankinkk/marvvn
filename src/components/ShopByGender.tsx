        ...
        <div className="grid md:grid-cols-2 gap-4 lg:gap-6">
          {categories.map((category) => (
            <Link
              key={category.title}
              href={category.link}
              className="group relative overflow-hidden bg-bonkers-gray-50 aspect-[4/3]"
            >
              <img
                src={category.image}
                alt={category.title}
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <span className="inline-flex items-center gap-1 text-white text-sm uppercase tracking-wider border-b border-white pb-0.5 hover:text-bonkers-gray-200 transition-colors">
