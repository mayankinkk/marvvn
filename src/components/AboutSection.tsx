  ...
  return (
    <section className="relative">
      <div className="grid lg:grid-cols-2 min-h-[500px]">
        ...
        <div className="bg-marvnn-black text-white flex items-center justify-center p-8 lg:p-16">
          <div className="max-w-md text-center lg:text-left">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-display font-bold mb-4">TIME TO GET WEIRD</h2>
            <p className="text-marvnn-gray-300 mb-6 text-lg">
              If found possessed, blame the fashion.<br />
              The drop you didn&apos;t see coming
            </p>
            <p className="text-sm text-marvnn-gray-400 mb-6">#Devilsinthedetails</p>
            ...
            <Link href="/pages/about-us" className="inline-block mt-6 text-sm underline underline-offset-4 hover:text-marvnn-gray-300 transition-colors">
              Read our story
            </Link>
          </div>
        </div>
