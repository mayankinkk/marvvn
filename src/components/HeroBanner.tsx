            ...
            <div className="absolute inset-0 flex items-center">
              <div className="container">
                <div className="max-w-xl">
                  ...
                  <Link
                    href={slide.ctaLink}
                    className="inline-flex items-center gap-2 text-white border-b-2 border-white pb-1 hover:text-bonkers-gray-200 hover:border-bonkers-gray-200 transition-colors text-sm md:text-base uppercase tracking-wider font-medium"
                  >
                    {slide.ctaText}
