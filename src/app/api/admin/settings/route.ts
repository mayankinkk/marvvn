...
const DEFAULTS: Record<string, string> = {
  ...
  invoice_terms: 'Return accepted within 3 days of delivery • Product must be unused & undamaged • Delivery charges are non-refundable • Damaged/used products are not accepted • Refund after quality inspection',
