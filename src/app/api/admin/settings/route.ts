...
const ALLOWED_KEYS = new Set([
  ...
  'invoice_return_policy', 'invoice_coupon_label', 'invoice_subtotal_label',
  'invoice_discount_label', 'invoice_shipping_label', 'invoice_gst_label',
  'invoice_total_label', 'invoice_paid_label', 'invoice_pending_label', 'invoice_failed_label',
  'invoice_payment_method_label', 'invoice_cod_label', 'invoice_online_label',
  'invoice_bill_to_label', 'invoice_payment_label', 'invoice_invoice_label',
  'invoice_order_label', 'invoice_order_date_label', 'invoice_invoice_date_label',
  'invoice_product_label', 'invoice_variant_label', 'invoice_qty_label',
  'invoice_rate_label', 'invoice_amount_label', 'invoice_free_label',
  'site_url',
])
...
const DEFAULTS: Record<string, string> = {
  ...
  invoice_prefix: 'INV',
  invoice_coupon_label: 'Coupon Applied',
  invoice_subtotal_label: 'Subtotal',
  invoice_discount_label: 'Discount',
  invoice_shipping_label: 'Shipping',
  invoice_gst_label: 'GST',
  invoice_total_label: 'TOTAL',
  invoice_paid_label: 'PAID',
  invoice_pending_label: 'PENDING',
  invoice_failed_label: 'FAILED',
  invoice_payment_method_label: 'Method',
  invoice_cod_label: 'Cash on Delivery',
  invoice_online_label: 'Online Payment',
  invoice_bill_to_label: 'Bill To',
  invoice_payment_label: 'Payment Details',
  invoice_invoice_label: 'TAX INVOICE',
  invoice_order_label: 'Order',
  invoice_order_date_label: 'Order Date',
  invoice_invoice_date_label: 'Invoice Date',
  invoice_product_label: 'Product',
  invoice_variant_label: 'Variant',
  invoice_qty_label: 'Qty',
  invoice_rate_label: 'Rate',
