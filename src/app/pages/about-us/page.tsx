    ...
    <div className="min-h-screen">
      ...
      <main className="container py-8 lg:py-12">
        <nav className="flex items-center gap-2 text-xs text-marvnn-gray-500 mb-6">
          ...
          <span className="text-marvnn-black">About Us</span>
        </nav>

        <div className="max-w-3xl mx-auto">
          <h1 className="text-2xl lg:text-3xl font-display font-medium mb-8">About MARVNN</h1>

          <div className="aspect-[16/9] bg-marvnn-gray-50 overflow-hidden mb-8">
            <img
          ...
          <div className="space-y-6 text-marvnn-gray-600">
            <p className="text-lg leading-relaxed">
              Born from the streets and built for the bold, MARVNN is not just a clothing brand — 
              it&apos;s a movement. We started with one simple idea: fashion should be fun, fearless, and 
              unapologetically YOU.
            </p>

            <h2 className="text-xl font-display font-medium text-marvnn-black pt-4">Our Story</h2>
            ...
            <h2 className="text-xl font-display font-medium text-marvnn-black pt-4">Our Mission</h2>
            <p className="leading-relaxed">
            ...
            <h2 className="text-xl font-display font-medium text-marvnn-black pt-4">Made in India</h2>
            <p className="leading-relaxed">
              Every MARVNN piece is proudly designed and made in India. We work with local
              manufacturers and artisans to bring you the best quality while supporting our homegrown 
              talent and industry.
            </p>

            <div className="bg-marvnn-black text-white p-8 mt-8">
              <p className="text-xl font-display font-bold text-center mb-2">TIME TO GET WEIRD</p>
              <p className="text-center text-marvnn-gray-300 text-sm">
                #Devilsinthedetails
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                ...
                <p className="text-sm text-marvnn-gray-500">Happy Customers</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-display font-bold mb-2">500+</p>
                <p className="text-sm text-marvnn-gray-500">Products</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-display font-bold mb-2">4.8</p>
                <p className="text-sm text-marvnn-gray-500">Average Rating</p>
              </div>
            </div>
          </div>
        </div>
