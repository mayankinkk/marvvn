...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How do I care for my Bonkers Corner clothes?', a: 'Machine wash cold with similar colors. Tumble dry low. Do not bleach or iron on print. Turn inside out before washing to preserve the design.' },
    ]
  },
  {
    ...
    <div className="min-h-screen">
      ...
      <main className="container py-8 lg:py-12">
        <nav className="flex items-center gap-2 text-xs text-bonkers-gray-500 mb-6">
          ...
          <span className="text-bonkers-black">FAQ</span>
        </nav>
                ...
                {cat.items.map((item, i) => {
                  ...
                  return (
                    <div key={key}>
                      ...
                      {isOpen && (
                        <p className="pb-4 text-sm text-bonkers-gray-600 leading-relaxed">{item.a}</p>
                      )}
                    </div>
                  )
                })}
        ...
        <div className="max-w-3xl mt-12 border p-6 text-center">
          <p className="text-sm text-bonkers-gray-600 mb-4">
