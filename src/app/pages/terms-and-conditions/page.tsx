      ...
      <main className="container py-8 lg:py-12">
        ...
        <div className="max-w-3xl">
          ...
          <div className="space-y-6 text-sm text-marvvn-gray-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-medium text-marvvn-black mb-3">2. Products & Pricing</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-medium text-marvvn-black mb-3">3. Orders & Payment</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-medium text-marvvn-black mb-3">5. Returns & Refunds</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-medium text-marvvn-black mb-3">6. Intellectual Property</h2>
              <p>
                All content on this website, including designs, images, logos, and text, is the 
                property of MARVVN and is protected by copyright laws. Unauthorized
                reproduction or distribution is prohibited.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-marvvn-black mb-3">7. Limitation of Liability</h2>
              <p>
                MARVVN shall not be liable for any indirect, incidental, or consequential
            ...
            <section>
              <h2 className="text-lg font-medium text-marvvn-black mb-3">8. Governing Law</h2>
              <p>
