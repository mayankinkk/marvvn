    ...
    <div className="min-h-screen">
      ...
      <main className="container py-8 lg:py-12">
        <nav className="flex items-center gap-2 text-xs text-marvnn-gray-500 mb-6">
          ...
          <span className="text-marvnn-black">Store Locator</span>
        </nav>

        <h1 className="text-2xl lg:text-3xl font-display font-medium mb-2">Find a Store</h1>
        <p className="text-sm text-marvnn-gray-500 mb-8">
          Visit us in person and experience the MARVNN collection
        </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {stores.map((store, i) => (
            <div key={i} className="border p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-3 text-sm text-marvnn-gray-600">
                <div className="flex items-start gap-2">
                  <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0 text-marvnn-gray-400" />
                  <span>{store.address}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="w-4 h-4 flex-shrink-0 text-marvnn-gray-400" />
                  <a href={`tel:${store.phone.replace(/\s/g, '')}`} className="hover:text-marvnn-black transition-colors">
                    {store.phone}
                  </a>
                </div>
                <div className="flex items-start gap-2">
                  <Clock className="w-4 h-4 mt-0.5 flex-shrink-0 text-marvnn-gray-400" />
        ...
        <div className="mt-12 bg-marvnn-gray-50 p-8 text-center">
          <h2 className="text-lg font-medium mb-2">Can&apos;t find a store near you?</h2>
          <p className="text-sm text-marvnn-gray-500 mb-4">
