    ...
    <div className="min-h-screen">
      ...
      <main className="container py-16 lg:py-24">
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="text-bonkers-gray-500 mb-2">Thank you for your purchase</p>
          <p className="text-sm text-bonkers-gray-400 mb-8">
            Order ID: <span className="font-mono font-medium text-bonkers-black">{orderId}</span>
          </p>

          <div className="border p-6 mb-8 text-left">
            <div className="flex items-center gap-3 mb-4">
              <Package className="w-5 h-5 text-bonkers-gray-400" />
              <div>
                <p className="text-sm font-medium">Estimated Delivery</p>
                <p className="text-sm text-bonkers-gray-500">3-5 business days</p>
              </div>
            </div>
