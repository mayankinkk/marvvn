    ...
    <div className="min-h-screen">
      ...
      <main className="container py-8 lg:py-12">
        <nav className="flex items-center gap-2 text-xs text-marvvn-gray-500 mb-6">
          ...
          <span className="text-marvvn-black">Wishlist</span>
        </nav>
        ...
        {items.length === 0 ? (
          <div className="text-center py-16">
            <Heart className="w-16 h-16 text-marvvn-gray-300 mx-auto mb-4" />
            <p className="text-marvvn-gray-500 mb-6">Your wishlist is empty</p>
