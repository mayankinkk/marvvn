    ...
    <div className="min-h-screen">
      ...
      <main className="container py-8 lg:py-16">
        <nav className="flex items-center gap-2 text-xs text-marvvn-gray-500 mb-8">
          ...
          <span className="text-marvvn-black">Register</span>
        </nav>

        <div className="max-w-md mx-auto">
          <h1 className="text-2xl lg:text-3xl font-display font-medium text-center mb-2">Create Account</h1>
          <p className="text-sm text-marvvn-gray-500 text-center mb-8">Join the MARVVN community</p>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-marvvn-gray-500">
              ...
              <Link href="/account/login" className="text-marvvn-black font-medium hover:underline">
                Sign in
              </Link>
            </p>
          </div>
